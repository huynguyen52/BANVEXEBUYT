	...
	<ul class="navbar-nav ml-auto">
			...
			<div
				...
				<a class="dropdown-item d-flex align-items-center" href="#">
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle" src='<c:url value="/sources/admin/img/undraw_profile_1.svg"/>' alt="">
					...
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle" src='<c:url value="/sources/admin/img/undraw_profile_2.svg"/>' alt="">
					...
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle" src='<c:url value="/sources/admin/img/undraw_profile_3.svg"/>' alt="">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false"> <span
				class="mr-2 d-none d-lg-inline text-gray-600 small">${sessionScope.email }</span> <img class="img-profile rounded-circle"
